...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-08-2017 a las 03:39:40
...
INSERT INTO `producto` (`id`, `nombre`, `descripcion`, `tipo`, `precio`, `calendario`, `id_restaurante`) VALUES
(1, 'Seco de Pollo', 'seco de pollo', 'S', 2.75, '2017-08-19', 1),
(2, 'a', 'a', 'A', 2.5, '2017-08-03', 1),
(3, 'cola', 'c', 'B', 0.5, '2017-08-03', 1),
(4, 'bistec', 'carne', 'S', 2.5, '2017-08-03', 2);
...
(9, 'oij', 'oijoij', 'oijoij', 1, 'ojo', 1),
(10, 'oij', 'oijoij', 'oijoij', 1, 'ojo', 1),
(11, 'andr', 'g', 'g', 1, '5', 1),
(12, 'oij', 'oijoij', 'oijoij', 1, 'ojo', 1);
...
ALTER TABLE `detalle_orden`
  ...
  ADD KEY `detalle_orden` (`id_orden`);
...
--
ALTER TABLE `detalle_orden`
  ADD CONSTRAINT `detalle_orden` FOREIGN KEY (`id_orden`) REFERENCES `orden` (`id`),
